...
.. container:: shortlist
    ...
    **Requirements (Python)**
    ...
    - :download:`createGateModel.py<code/tut1/createGateModel.py>` Either the skeleton code, or ..
    - :download:`createGateModel_completed.py<code/tut1/createGateModel_completed.py>` the completed tutorial code.
...
.. container:: toggle
    ...
    .. literalinclude:: ../hh_tutorials/code/tut1/createGateModel_completed.cpp
        :language: c++
        :start-at: //  1.a
        :end-before: // end 1
...
.. container:: toggle
    ...
    .. literalinclude:: ../hh_tutorials/code/tut1/createGateModel_completed.py
        :language: python
        :start-at: #  1.a
        :end-before: # end 1
