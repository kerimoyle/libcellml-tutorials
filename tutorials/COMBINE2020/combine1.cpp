...
int main()
{
    ...
    //  7.a Use the printModelToTerminal() function to show your current model contents. This should
    ...
    //  10.g Connect all the variables in the nGate equations component to the dummy variables
