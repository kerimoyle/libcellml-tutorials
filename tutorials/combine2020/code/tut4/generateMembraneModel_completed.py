...
from tutorial_utilities import print_issues, print_model, get_item_type_from_enum, get_issue_level_from_enum, print_encapsulation
...
if __name__ == '__main__':
    ...
    #  4.e (C profile only) If you're using the C profile then you have the option at this stage 
    ...
    #  4.g (C profile only) Interface code is the header needed by the C profile to define data types.
