...
from libcellml import Annotator, CellMLElement, Component, Importer, Model, Parser, Units, Variable
...
if __name__ == '__main__':
    ...
    #     - first attribute is a CellMLElement enumeration and
    ...
    #      be a CellMLElement.VARIABLE) we can name its second attribute so we know
    #      what it is.
    ...
    #  3.b
    #      The item type returned is CellMLElement.UNDEFINED ... so we 
    ...
    for id in duplicated_ids:
        print('  - "{}" occurs {} times'.format(id, annotator.duplicateCount(id)))

    #  4.c
    #      Loop through all of the model's components and print their id to the terminal.
    #      Use the assignIds string with an item type (CellMLElement.COMPONENT)
