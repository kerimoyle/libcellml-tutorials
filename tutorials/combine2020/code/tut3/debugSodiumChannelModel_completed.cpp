...
int main()
{
    ...
    assert(issue6->cellmlElementType() == libcellml::CellmlElementType::VARIABLE);
    ...
    assert(issue7->cellmlElementType() == libcellml::CellmlElementType::UNIT);
    auto issue7item = issue7->unit();
    issue7item->units()->removeUnit(issue7item->index());
    issue7item->units()->addUnit("volt", "milli");
    ...
    assert(issue9->cellmlElementType() == libcellml::CellmlElementType::VARIABLE);
