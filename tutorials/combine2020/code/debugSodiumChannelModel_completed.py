...
from libcellml import Analyser, Component, Importer, ItemType, Model, Parser, Printer, Units, Validator, Variable

from tutorial_utilities import print_issues, print_model, get_item_type_from_enum, get_issue_level_from_enum, print_encapsulation_structure_to_terminal
...
if __name__ == '__main__':
    ...
    #      - retrieving an AnyItem pair (whose 'first' attribute is an enum of the ItemType 
    ...
    print('Issue 6 is a {}'.format(get_item_type_from_enum(issue6.itemType())))
    ...
    print('Issue 7 is a {}'.format(get_item_type_from_enum(issue7.itemType())))
    issue7_units = issue7.unit().first
    issue7_units.removeUnit(issue7.unit().second)
